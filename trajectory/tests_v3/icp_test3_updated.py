...
if smoothed == 1:
    RESULTS_FILE = "../../data/tests_v3/gtsam_pose_smoothed_small_medium_yaw.csv"
    GT_FILE = "../../data/tests_v3/smoothed_small.csv"
    x1 = 0.1
    y1 = 0.0
    it0 = 9
    output_file = "../../data/tests_v3/errors_smoothed_all.csv"
    output_file_x = "../../data/tests_v3/errors_x_smoothed.csv"
    output_file_y = "../../data/tests_v3/errors_y_smoothed.csv"
    max_id = 1740
else:
    RESULTS_FILE = "../../data/tests_v3/gtsam_pose_unsmoothed_interpolated_small_medium_yaw.csv" 
    GT_FILE = "../../data/tests_v3/interpolated_unsmoothed_small.csv"
    x1 = 0.1
    y1 = 0.0
    it0 = 0
    output_file = "../../data/tests_v3/errors_unsmoothed_all.csv"
    output_file_x = "../../data/tests_v3/errors_x_unsmoothed.csv"
    output_file_y = "../../data/tests_v3/errors_y_unsmoothed.csv"
    max_id = 2305
